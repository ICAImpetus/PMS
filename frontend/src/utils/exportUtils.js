...
export const FORMS_AVAILABLE_COLUMNS = [
    ...
    { key: "formData.patientDetails.status", label: "Patient Status" },
    { key: "formData.patientDetails.patientAge", label: "Patient Age" },
    { key: "formData.patientDetails.category", label: "Patient Category" },
    { key: "formData.patientDetails.location", label: "Patient Location" },
    { key: "formData.patientDetails.gender", label: "Patient Gender" },
    { key: "callStatus", label: "Call Status" },
    { key: "purpose", label: "POC / Purpose" },
