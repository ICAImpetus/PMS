import { TextField, MenuItem, Button, Box, Rating, Typography, useTheme, FormControl, FormControlLabel, FormLabel, Radio, RadioGroup, Checkbox,FormHelperText } from '@mui/material';
...
import RatingWithLabels from './RatingWithLabels';
...
export const renderField = (field, index, handleChange, formData, errors) => {
    ...
    // const isError = field.required && !fieldValue;
            ...
            return (
                <Box key={`${field.name}-${index}`}  >
                    ...
                    {/* <Typography variant="body2" sx={{ mt: 1, fontWeight: 'bold' }}>
                        {hover !== -1 ? labels[hover] : labels[fieldValue] || ''}
                    </Typography> */}
                </Box>
            );
                ...
                <>
                    ...
                    <LocalizationProvider dateAdapter={AdapterDayjs}>
                        <DatePicker
                            ...
                            renderInput={(params) => (
                                <TextField {...params} fullWidth required={field.isRequired} margin="normal" error={isError} helperText={isError ? 'This field is required' : ''} />
                            )}
                        />
